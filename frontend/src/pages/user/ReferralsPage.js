    ...
    <UserLayout>
      <div className="max-w-5xl mx-auto p-6 md:p-12 space-y-12 fade-in">
        ...
        <section data-testid="crew-members-section" className="space-y-6">
          <p className="text-xs tracking-[0.2em] uppercase text-[#A1A1AA] font-bold">
            {t('referrals.yourCrew')} ({mockReferrals.length} {t('referrals.members')})
          </p>
          <div className="space-y-3">
            {mockReferrals.map((referral) => (
              ...
              >
                <img src={referral.avatar_url} alt={referral.full_name} className="w-12 h-12 rounded-full object-cover border border-[#222222]" />
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-base mb-1">{referral.full_name}</h3>
