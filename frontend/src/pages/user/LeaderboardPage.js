            ...
            {mockPrizes.map((prize) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <h3 className="text-white font-bold text-lg">{prize.title}</h3>
                </div>
              </div>
            ))}
          </div>
              ...
              return (
                ...
                >
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#09090B] border border-[#222222] flex items-center justify-center">
                    <span className={cn("font-mono font-black text-xl", isTopThree ? "text-[#10B981]" : "text-[#A1A1AA]")}>
                      {user.rank}
                    </span>
                  </div>
                  <img src={user.avatar_url} alt={user.full_name} className="w-12 h-12 rounded-full object-cover border border-[#222222]" />
                  <div className="flex-1">
                    <h3 className="text-white font-semibold text-base mb-1">{user.full_name}</h3>
                    <p className="text-[#A1A1AA] text-sm">{user.location}</p>
                  </div>
                  <div className="text-right">
                    <p className={cn("font-mono font-black text-xl", isTopThree ? "text-[#10B981]" : "text-white")}>
